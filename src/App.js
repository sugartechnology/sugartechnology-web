	...
	return (
		<div>
			...
			<Routes>
				...
				<Route path='/productAr' element={<ProductAr />}></Route>
				<Route path='/productMeta' element={<ProductMeta />}></Route>
				<Route path='/productJoint' element={<ProductJoint />}></Route>
				<Route path='/productWatch' element={<ProductWatch />}></Route>
				<Route path='/productShoes' element={<ProductShoes />}></Route>
				<Route path='/productClooth' element={<ProductClooth />}></Route>
				<Route path='/productCarpet' element={<ProductCarpet />}></Route>
				<Route path='/productTable' element={<ProductTable />}></Route>
				<Route path='/productBathroom' element={<ProductBathroom />}></Route>
				<Route path='/productWhiteGoods' element={<ProductWhiteGoods />}></Route>
