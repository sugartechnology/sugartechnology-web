    ...
    return(
        <div className='MetaverseProjectContainer'>
            ...
            <div className='metaverseProjectElements'>
                ...
                <iframe className='metaverseProjectElement' style={{width: "50%"}} width="560" height="315" src="https://www.youtube.com/embed/OS8WDifCz54" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>
            </div>
        </div>
    );
}