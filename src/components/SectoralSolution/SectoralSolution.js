        ...
        <div className='sectoralSolutionContainer'>
            ...
            <div className='solution'>
                ...
                <div className='solutionImage'>
                    <img alt='' src={'./assets/img/sugar-model-viewer.svg'}></img>
                </div>
            </div>

            <div className='solution'>
                <div className='solutionImage'>
                    <img alt='' src={'./assets/img/solutionImage2.svg'}></img>
                </div>
                <div className='solutionSpans' style={{position: "relative", left: "100px"}}>
            ...
            <div className='solution'>
                ...
                <div className='solutionImage'>
                    <img alt='' src={'./assets/img/solutionImage3.svg'}></img>
                </div>
            </div>

            <div className='solution'>
                <div className='solutionImage'>
                    <img alt='' src={'./assets/img/solutionImage4.svg'}></img>
                </div>
                <div className='solutionSpans' style={{position: "relative", left: "100px"}}>
