...
export const ContactCv = (props) => {
  ...
  const closePopup = () => {
    ...
    let informationLoadingPopup = document.querySelector(
      "#informationLoadingPopup"
    );
    let informationErrorPopup = document.querySelector(
      "#informationErrorPopup"
    );
  ...
  function informationErrorPopup() {
    ...
    const informationLoadingPopup = document.querySelector(
      "#informationLoadingPopup"
    );
    informationLoadingPopup.style.display = "none";
    inputPopup.style.display = "flex";
  ...
  return (
    <div className="contactCvContainer">
      ...
      <div
        className="mainPageSmallFigure bright"
        style={{
          width: "243px",
          height: "233px",
          left: "498px",
        ...
        <div className="nameEmailInputsCv">
          ...
          <div className="emailInputsCv">
            ...
            <input
              className="cvInput"
              type="file"
              placeholder={t("fileChoosen")}
              value={cv}
              onChange={cvDoubleMethod}
            ></input>
        ...
        <div className="contactOptions">
          ...
          <div className="contactOption">
            ...
            <label htmlFor="secondOption">
              Lorem ipsum dolor sit amet consectetur. Potenti turpis aenean
              tempus aliquam metus at. Ultricies vel adipiscing volutpat erat.
            </label>
          </div>
        </div>
        <ReCAPTCHA
          className="contactCvRecaptcha"
      ...
      <div className="inputDonePopup" id="inputDonePopup">
        <div className="inputPopupButton">
          <img
            className="inputPopupCloseButton"
            onClick={closePopup}
            alt=""
            src={"./assets/img/inputPopupButton.svg"}
          ></img>
        </div>
        <div className="inputPopupSpans">
          <img
            className="inputPopupImg"
            alt=""
            src={"./assets/img/inputPopupImg.svg"}
          ></img>
          <a className="inputPopupHeader">{t("contactHeaderSuccesfuly")}</a>
          <a className="inputPopupSpan">{t("contactSpanSuccesfuly")}</a>
          <img
            className="inputPopupLine"
            alt=""
            src={"./assets/img/contactPopupLine.svg"}
          ></img>
          <a className="inputPopupSecondSpan">
            {t("contactSecondSpanSuccesfuly")}
          </a>
        </div>
      </div>
      <div className="inputDonePopup" id="inputErrorPopup">
        ...
        <div className="inputPopupSpans">
          <img
            className="inputPopupImg"
            alt=""
            src={"./assets/img/inputErrorPopupImg.svg"}
          ></img>
          ...
          <a className="inputPopupSecondSpan">
            hello@sugartech.io && +905342843427
          </a>
        </div>
      </div>
      <div className="inputDonePopup" id="informationLoadingPopup">
        ...
        <div className="inputPopupButton">
          <img
            className="informationLoadingButton"
            onClick={closePopup}
            alt=""
            src={"./assets/img/inputPopupButton.svg"}
          ></img>
      ...
      <div className="inputDonePopup" id="informationErrorPopup">
        ...
        <div className="inputPopupButton">
          <img
            className="informationErrorButton"
            onClick={closePopup}
            alt=""
            src={"./assets/img/inputPopupButton.svg"}
          ></img>
