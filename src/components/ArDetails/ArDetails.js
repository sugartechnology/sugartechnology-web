    ...
    return(
        <div className='arDetailsContainer'>
            <div className='arDetailsSpans'>
                ...
                <sugar-model-viewer class="modelViewer" id="sugar" style={{ width:"100%" ,height: "600px", background: "white",margin: "auto" ,display: "block" ,marginBottom: "60px" ,paddingBottom: "60px"}} ar="" shadow-intensity="1" show-model-group
